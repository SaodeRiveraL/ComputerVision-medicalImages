...
def test():
    with torch.no_grad():
        ...
        pd.DataFrame(test_loss_item, columns = ['batch','loss','acc']).to_csv(METRICS_DIR+'test_loss_hist_item3.csv', index =False)
        pd.DataFrame(pred_labels_per_hist, columns = ['0','1','2','3','4','5']).to_csv(METRICS_DIR+'pred_labels_per3_test.csv', index = False)
        pd.DataFrame(pred_labels_hist, columns = ['0','1','2','3','4','5']).to_csv(METRICS_DIR+'pred_labels3_test.csv', index = False)
        pd.DataFrame(target_hist, columns = ['0','1','2','3','4','5']).to_csv(METRICS_DIR+'target_labels3_test.csv', index = False)
...
pdtest_loss_hist.to_csv(METRICS_DIR+'test_loss3.csv',index=False)
